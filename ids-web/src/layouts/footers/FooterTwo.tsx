...
import bg from "@/assets/img/home-1/footer-bg.jpg"
        ...
        <footer className="footer-section style-2 fix">
            <div className="footer-area bg-cover" style={{ backgroundImage: `url(${bg.src})` }}>
                <div className="container">
                                ...
                                <div className="footer-widget-items">
                                    ...
                                    <div className="footer-content">
                                        <p>
                                            ...
                                            systems that drive growth an efficiency. From IT consulting.
                                        </p>
                    ...
                    <div className="footer-newsletter-box scale-animation">
