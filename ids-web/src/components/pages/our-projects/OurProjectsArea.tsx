...
const OurProjectsArea = () => {
    ...
    useClipMaskAnimation({ dependencies: [itemOffset, activeTab] });
    ...
    const handleTabClick = (tab: 'development' | 'digital-marketing') => {
        setActiveTab(tab);
        setItemOffset(0);
    };
    ...
    return (
        <section className="project-section-2 section-padding fix">
            <div className="container">
                ...
                <div className="portfolio-tabs-wrapper d-flex justify-content-center mb-5 wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div key={item.id} className="col-lg-6">
                            <div className="portfolio-premium-card" style={{
                                ...
                                <div className="premium-card-header">
                                    {item.logo ? (
                                        <div className="premium-card-logo" style={{ background: '#fff', overflow: 'hidden' }}>
                                            <Image src={item.logo} alt="logo" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                        </div>
                                    ) : (
                                        <div className="premium-card-logo" style={{ background: item.cardLogoBg || "var(--theme)" }}>
                                ...
                                <div className="premium-card-body">
                                    ...
                                    <div className="premium-card-image-wrapper">
                                        <Link href={`/our-project-details?id=${item.id}`} style={{ display: "block", width: "100%", height: "100%" }}>
                                            <Image
                                                src={item.thumb}
                                                alt={item.title}
            ...
            {/* Custom styles for redirection & platform buttons */}
...
export default OurProjectsArea
