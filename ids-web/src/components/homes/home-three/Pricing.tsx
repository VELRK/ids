...
import bg_img from "@/assets/img/home-3/pricing-bg.jpg"
...
const Pricing = () => {
    ...
    return (
        <section className="pricing-section-3 section-padding fix bg-cover" style={{ backgroundImage: `url(${bg_img.src})` }}>
                            ...
                            <div className="row">
                                {item.pricing_details.map((item) => (
                                    <div key={item.id} className="col-xl-4 col-lg-6 col-md-6">
                                        <div className="pricing-card-items-3">
